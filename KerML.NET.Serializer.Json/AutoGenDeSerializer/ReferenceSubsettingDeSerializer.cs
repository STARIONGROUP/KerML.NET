...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class ReferenceSubsettingDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IReferenceSubsetting DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Core.Features.ReferenceSubsetting();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("general"u8, out _))
            {
                logger.LogDebug($"the ReferenceSubsetting.General property is Redefined property which should not be present in the JSON. It was found in ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("owningFeature"u8, out _))
            {
                logger.LogDebug($"the ReferenceSubsetting.OwningFeature property is Redefined property which should not be present in the JSON. It was found in ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("owningType"u8, out _))
            {
                logger.LogDebug($"the ReferenceSubsetting.OwningType property is Redefined property which should not be present in the JSON. It was found in ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("referencedFeature"u8, out JsonElement referencedFeatureProperty))
            {
                ...
                {
                    dtoInstance.ReferencedFeature = "-";
                    logger.LogDebug("the ReferenceSubsetting.ReferencedFeature property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (referencedFeatureProperty.TryGetProperty("@id"u8, out JsonElement referencedFeatureAtIdProperty))
                    {
                        var propertyValue = referencedFeatureAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.ReferencedFeature = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the referencedFeature Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("referencingFeature"u8, out JsonElement getReferencingFeatureProperty))
            {
                if (getReferencingFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetReferencingFeature = "-";
                    logger.LogDebug("the ReferenceSubsetting.ReferencingFeature property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getReferencingFeatureProperty.TryGetProperty("@id"u8, out JsonElement getReferencingFeatureAtIdProperty))
                    {
                        var propertyValue = getReferencingFeatureAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetReferencingFeature = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the referencingFeature Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the ReferenceSubsetting.Source property is Redefined property which should not be present in the JSON. It was found in ReferenceSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("specific"u8, out _))
            {
                logger.LogDebug($"the ReferenceSubsetting.Specific property is Redefined property which should not be present in the JSON. It was found in ReferenceSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("subsettedFeature"u8, out _))
            {
                logger.LogDebug($"the ReferenceSubsetting.SubsettedFeature property is Redefined property which should not be present in the JSON. It was found in ReferenceSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("subsettingFeature"u8, out _))
            {
                logger.LogDebug($"the ReferenceSubsetting.SubsettingFeature property is Redefined property which should not be present in the JSON. It was found in ReferenceSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the ReferenceSubsetting.Target property is Redefined property which should not be present in the JSON. It was found in ReferenceSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the ReferenceSubsetting: {dtoInstance.ElementId}");
            }
