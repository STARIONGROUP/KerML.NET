// -------------------------------------------------------------------------------------------------
// <copyright file="ConjugationDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class ConjugationDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IConjugation DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            if (type.GetString() != "Conjugation")
            {
                throw new InvalidOperationException($"The ConjugationDeSerializer can only be used to deserialize objects of type IConjugation, a {type.GetString()} was provided");
            }

            var dtoInstance = new KerML.NET.DTO.Core.Types.Conjugation();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("conjugatedType"u8, out JsonElement conjugatedTypeProperty))
            {
                ...
                {
                    dtoInstance.ConjugatedType = "-";
                    logger.LogDebug("the Conjugation.ConjugatedType property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (conjugatedTypeProperty.TryGetProperty("@id"u8, out JsonElement conjugatedTypeAtIdProperty))
                    {
                        var propertyValue = conjugatedTypeAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.ConjugatedType = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the conjugatedType Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("originalType"u8, out JsonElement originalTypeProperty))
            {
                ...
                {
                    dtoInstance.OriginalType = "-";
                    logger.LogDebug("the Conjugation.OriginalType property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (originalTypeProperty.TryGetProperty("@id"u8, out JsonElement originalTypeAtIdProperty))
                    {
                        var propertyValue = originalTypeAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.OriginalType = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the originalType Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningType Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the Conjugation.Source property is Redefined property which should not be present in the JSON. It was found in Conjugation: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the Conjugation.Target property is Redefined property which should not be present in the JSON. It was found in Conjugation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the Conjugation: {dtoInstance.ElementId}");
            }
