...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class DisjoiningDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IDisjoining DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Core.Types.Disjoining();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("disjoiningType"u8, out JsonElement disjoiningTypeProperty))
            {
                if (disjoiningTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.DisjoiningType = "-";
                    logger.LogDebug("the Disjoining.DisjoiningType property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (disjoiningTypeProperty.TryGetProperty("@id"u8, out JsonElement disjoiningTypeAtIdProperty))
                    {
                        var propertyValue = disjoiningTypeAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.DisjoiningType = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the disjoiningType Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningType Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the Disjoining.Source property is Redefined property which should not be present in the JSON. It was found in Disjoining: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the Disjoining.Target property is Redefined property which should not be present in the JSON. It was found in Disjoining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("typeDisjoined"u8, out JsonElement typeDisjoinedProperty))
            {
                if (typeDisjoinedProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.TypeDisjoined = "-";
                    logger.LogDebug("the Disjoining.TypeDisjoined property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (typeDisjoinedProperty.TryGetProperty("@id"u8, out JsonElement typeDisjoinedAtIdProperty))
                    {
                        var propertyValue = typeDisjoinedAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.TypeDisjoined = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the typeDisjoined Json property was not found in the Disjoining: {dtoInstance.ElementId}");
            }
