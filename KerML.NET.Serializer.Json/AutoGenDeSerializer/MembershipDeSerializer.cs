// -------------------------------------------------------------------------------------------------
// <copyright file="MembershipDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class MembershipDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Root.Namespaces.Membership();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("memberElement"u8, out JsonElement memberElementProperty))
            {
                ...
                {
                    dtoInstance.MemberElement = "-";
                    logger.LogDebug("the Membership.MemberElement property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (memberElementProperty.TryGetProperty("@id"u8, out JsonElement memberElementAtIdProperty))
                    {
                        var propertyValue = memberElementAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.MemberElement = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the memberElement Json property was not found in the Membership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberElementId"u8, out JsonElement getMemberElementIdProperty))
            {
                var propertyValue = getMemberElementIdProperty.GetString();
                if (propertyValue != null)
                {
                    dtoInstance.GetMemberElementId = propertyValue;
                }
            }
            else
            {
                logger.LogDebug($"the memberElementId Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the memberName Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("membershipOwningNamespace"u8, out JsonElement getMembershipOwningNamespaceProperty))
            {
                if (getMembershipOwningNamespaceProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the Membership.MembershipOwningNamespace property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the membershipOwningNamespace Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the memberShortName Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Membership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the Membership.Source property is Redefined property which should not be present in the JSON. It was found in Membership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the Membership.Target property is Redefined property which should not be present in the JSON. It was found in Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the Membership: {dtoInstance.ElementId}");
            }
