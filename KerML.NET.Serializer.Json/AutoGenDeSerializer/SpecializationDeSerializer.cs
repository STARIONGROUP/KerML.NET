// -------------------------------------------------------------------------------------------------
// <copyright file="SpecializationDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// <summary>
    /// The purpose of the <see cref="SpecializationDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="ISpecialization"/> interface
    /// </summary>
    public static class SpecializationDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ISpecialization"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        /// </returns>
        public static ISpecialization DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the SpecializationDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (type.GetString() != "Specialization")
            {
            ...
            var dtoInstance = new KerML.NET.DTO.Core.Types.Specialization();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the Specialization cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("general"u8, out JsonElement generalProperty))
            {
                ...
                {
                    dtoInstance.General = "-";
                    logger.LogDebug("the Specialization.General property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (generalProperty.TryGetProperty("@id"u8, out JsonElement generalAtIdProperty))
                    {
                        var propertyValue = generalAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.General = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the general Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningType Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the Specialization.Source property is Redefined property which should not be present in the JSON. It was found in Specialization: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("specific"u8, out JsonElement specificProperty))
            {
                ...
                {
                    dtoInstance.Specific = "-";
                    logger.LogDebug("the Specialization.Specific property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (specificProperty.TryGetProperty("@id"u8, out JsonElement specificAtIdProperty))
                    {
                        var propertyValue = specificAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.Specific = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the specific Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the Specialization.Target property is Redefined property which should not be present in the JSON. It was found in Specialization: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the Specialization: {dtoInstance.ElementId}");
            }
