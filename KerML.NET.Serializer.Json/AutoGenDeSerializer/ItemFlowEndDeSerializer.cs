// -------------------------------------------------------------------------------------------------
// <copyright file="ItemFlowEndDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ItemFlowEndDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IItemFlowEnd"/> interface
    /// </summary>
    public static class ItemFlowEndDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IItemFlowEnd"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        /// <param name="jsonElement">
        /// The <see cref="JsonElement"/> that contains the <see cref="IItemFlowEnd"/> json object
        /// </param>
        ...
        /// </returns>
        public static IItemFlowEnd DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            var logger = loggerFactory == null ? NullLogger.Instance : loggerFactory.CreateLogger("ItemFlowEndDeSerializer");

            if (!jsonElement.TryGetProperty("@type"u8, out JsonElement type))
            {
                throw new InvalidOperationException("The @type property is not available, the ItemFlowEndDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (type.GetString() != "ItemFlowEnd")
            {
                throw new InvalidOperationException($"The ItemFlowEndDeSerializer can only be used to deserialize objects of type IItemFlowEnd, a {type.GetString()} was provided");
            }

            var dtoInstance = new KerML.NET.DTO.Kernel.Interactions.ItemFlowEnd();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the ItemFlowEnd cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the chainingFeature Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the crossFeature Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the differencingType Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the directedFeature Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the direction Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the endFeature Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the endOwningType Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the feature Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the featureMembership Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("featureTarget"u8, out JsonElement getFeatureTargetProperty))
            {
                if (getFeatureTargetProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the ItemFlowEnd.FeatureTarget property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the featureTarget Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the featuringType Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the importedMembership Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the inheritedFeature Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the inheritedMembership Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the input Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the intersectingType Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isComposite Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isConjugated Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isDerived Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isEnd Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isOrdered Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isPortion Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isUnique Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the member Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the membership Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the multiplicity Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the output Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedConjugator Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedCrossSubsetting Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedDifferencing Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedDisjoining Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedEndFeature Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeature Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeatureChaining Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeatureInverting Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeatureMembership Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedImport Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedIntersecting Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMember Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMembership Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRedefinition Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedReferenceSubsetting Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedSpecialization Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedSubsetting Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedTypeFeaturing Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedTyping Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedUnioning Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningFeatureMembership Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningType Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the type Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the unioningType Json property was not found in the ItemFlowEnd: {dtoInstance.ElementId}");
            }
