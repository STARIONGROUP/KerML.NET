...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class TypeFeaturingDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static ITypeFeaturing DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Core.Features.TypeFeaturing();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("feature"u8, out _))
            {
                logger.LogDebug($"the TypeFeaturing.Feature property is Redefined property which should not be present in the JSON. It was found in TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("featureOfType"u8, out JsonElement featureOfTypeProperty))
            {
                ...
                {
                    dtoInstance.FeatureOfType = "-";
                    logger.LogDebug("the TypeFeaturing.FeatureOfType property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (featureOfTypeProperty.TryGetProperty("@id"u8, out JsonElement featureOfTypeAtIdProperty))
                    {
                        var propertyValue = featureOfTypeAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.FeatureOfType = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the featureOfType Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("featuringType"u8, out JsonElement featuringTypeProperty))
            {
                ...
                {
                    dtoInstance.FeaturingType = "-";
                    logger.LogDebug("the TypeFeaturing.FeaturingType property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (featuringTypeProperty.TryGetProperty("@id"u8, out JsonElement featuringTypeAtIdProperty))
                    {
                        var propertyValue = featuringTypeAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.FeaturingType = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the featuringType Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("owningFeatureOfType"u8, out JsonElement getOwningFeatureOfTypeProperty))
            {
                if (getOwningFeatureOfTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetOwningFeatureOfType = null;
                }
                else
                {
                    if (getOwningFeatureOfTypeProperty.TryGetProperty("@id"u8, out JsonElement getOwningFeatureOfTypeAtIdProperty))
                    {
                        var propertyValue = getOwningFeatureOfTypeAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetOwningFeatureOfType = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the owningFeatureOfType Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the TypeFeaturing.Source property is Redefined property which should not be present in the JSON. It was found in TypeFeaturing: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the TypeFeaturing.Target property is Redefined property which should not be present in the JSON. It was found in TypeFeaturing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the TypeFeaturing: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("type"u8, out _))
            {
                logger.LogDebug($"the TypeFeaturing.Type property is Redefined property which should not be present in the JSON. It was found in TypeFeaturing: {dtoInstance.ElementId}");
            }
