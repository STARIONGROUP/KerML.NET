// -------------------------------------------------------------------------------------------------
// <copyright file="CrossSubsettingDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// <summary>
    /// The purpose of the <see cref="CrossSubsettingDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="ICrossSubsetting"/> interface
    /// </summary>
    public static class CrossSubsettingDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ICrossSubsetting"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        /// </returns>
        public static ICrossSubsetting DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the CrossSubsettingDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (type.GetString() != "CrossSubsetting")
            {
            ...
            var dtoInstance = new KerML.NET.DTO.Core.Features.CrossSubsetting();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the CrossSubsetting cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("crossedFeature"u8, out JsonElement crossedFeatureProperty))
            {
                if (crossedFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.CrossedFeature = "-";
                    logger.LogDebug("the CrossSubsetting.CrossedFeature property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (crossedFeatureProperty.TryGetProperty("@id"u8, out JsonElement crossedFeatureAtIdProperty))
                    {
                        var propertyValue = crossedFeatureAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.CrossedFeature = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the crossedFeature Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("crossingFeature"u8, out JsonElement getCrossingFeatureProperty))
            {
                if (getCrossingFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetCrossingFeature = "-";
                    logger.LogDebug("the CrossSubsetting.CrossingFeature property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getCrossingFeatureProperty.TryGetProperty("@id"u8, out JsonElement getCrossingFeatureAtIdProperty))
                    {
                        var propertyValue = getCrossingFeatureAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetCrossingFeature = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the crossingFeature Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("general"u8, out _))
            {
                logger.LogDebug($"the CrossSubsetting.General property is Redefined property which should not be present in the JSON. It was found in CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("owningFeature"u8, out _))
            {
                logger.LogDebug($"the CrossSubsetting.OwningFeature property is Redefined property which should not be present in the JSON. It was found in CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("owningType"u8, out _))
            {
                logger.LogDebug($"the CrossSubsetting.OwningType property is Redefined property which should not be present in the JSON. It was found in CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the CrossSubsetting.Source property is Redefined property which should not be present in the JSON. It was found in CrossSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("specific"u8, out _))
            {
                logger.LogDebug($"the CrossSubsetting.Specific property is Redefined property which should not be present in the JSON. It was found in CrossSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("subsettedFeature"u8, out _))
            {
                logger.LogDebug($"the CrossSubsetting.SubsettedFeature property is Redefined property which should not be present in the JSON. It was found in CrossSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("subsettingFeature"u8, out _))
            {
                logger.LogDebug($"the CrossSubsetting.SubsettingFeature property is Redefined property which should not be present in the JSON. It was found in CrossSubsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the CrossSubsetting.Target property is Redefined property which should not be present in the JSON. It was found in CrossSubsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the CrossSubsetting: {dtoInstance.ElementId}");
            }
