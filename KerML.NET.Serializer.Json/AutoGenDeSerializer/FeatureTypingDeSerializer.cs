...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class FeatureTypingDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IFeatureTyping DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Core.Features.FeatureTyping();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("general"u8, out _))
            {
                logger.LogDebug($"the FeatureTyping.General property is Redefined property which should not be present in the JSON. It was found in FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningFeature Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("owningType"u8, out _))
            {
                logger.LogDebug($"the FeatureTyping.OwningType property is Redefined property which should not be present in the JSON. It was found in FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the FeatureTyping.Source property is Redefined property which should not be present in the JSON. It was found in FeatureTyping: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("specific"u8, out _))
            {
                logger.LogDebug($"the FeatureTyping.Specific property is Redefined property which should not be present in the JSON. It was found in FeatureTyping: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the FeatureTyping.Target property is Redefined property which should not be present in the JSON. It was found in FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("type"u8, out JsonElement typeProperty))
            {
                ...
                {
                    dtoInstance.Type = "-";
                    logger.LogDebug("the FeatureTyping.Type property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (typeProperty.TryGetProperty("@id"u8, out JsonElement typeAtIdProperty))
                    {
                        var propertyValue = typeAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.Type = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the type Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("typedFeature"u8, out JsonElement typedFeatureProperty))
            {
                ...
                {
                    dtoInstance.TypedFeature = "-";
                    logger.LogDebug("the FeatureTyping.TypedFeature property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (typedFeatureProperty.TryGetProperty("@id"u8, out JsonElement typedFeatureAtIdProperty))
                    {
                        var propertyValue = typedFeatureAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.TypedFeature = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the typedFeature Json property was not found in the FeatureTyping: {dtoInstance.ElementId}");
            }
