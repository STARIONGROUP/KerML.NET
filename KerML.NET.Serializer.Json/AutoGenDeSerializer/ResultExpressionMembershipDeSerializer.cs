// -------------------------------------------------------------------------------------------------
// <copyright file="ResultExpressionMembershipDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ResultExpressionMembershipDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IResultExpressionMembership"/> interface
    /// </summary>
    public static class ResultExpressionMembershipDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IResultExpressionMembership"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        /// </returns>
        public static IResultExpressionMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ResultExpressionMembershipDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (type.GetString() != "ResultExpressionMembership")
            {
            ...
            var dtoInstance = new KerML.NET.DTO.Kernel.Functions.ResultExpressionMembership();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the ResultExpressionMembership cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("feature"u8, out _))
            {
                logger.LogDebug($"the ResultExpressionMembership.Feature property is Redefined property which should not be present in the JSON. It was found in ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberElement"u8, out _))
            {
                logger.LogDebug($"the ResultExpressionMembership.MemberElement property is Redefined property which should not be present in the JSON. It was found in ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberElementId"u8, out _))
            {
                logger.LogDebug($"the ResultExpressionMembership.MemberElementId property is Redefined property which should not be present in the JSON. It was found in ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberName"u8, out _))
            {
                logger.LogDebug($"the ResultExpressionMembership.MemberName property is Redefined property which should not be present in the JSON. It was found in ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("membershipOwningNamespace"u8, out _))
            {
                logger.LogDebug($"the ResultExpressionMembership.MembershipOwningNamespace property is Redefined property which should not be present in the JSON. It was found in ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberShortName"u8, out _))
            {
                logger.LogDebug($"the ResultExpressionMembership.MemberShortName property is Redefined property which should not be present in the JSON. It was found in ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out _))
            {
                logger.LogDebug($"the ResultExpressionMembership.OwnedMemberElement property is Redefined property which should not be present in the JSON. It was found in ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberElementId Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("ownedMemberFeature"u8, out _))
            {
                logger.LogDebug($"the ResultExpressionMembership.OwnedMemberFeature property is Redefined property which should not be present in the JSON. It was found in ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberName Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberShortName Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("ownedResultExpression"u8, out JsonElement getOwnedResultExpressionProperty))
            {
                if (getOwnedResultExpressionProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetOwnedResultExpression = "-";
                    logger.LogDebug("the ResultExpressionMembership.OwnedResultExpression property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getOwnedResultExpressionProperty.TryGetProperty("@id"u8, out JsonElement getOwnedResultExpressionAtIdProperty))
                    {
                        var propertyValue = getOwnedResultExpressionAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetOwnedResultExpression = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the ownedResultExpression Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("owningType"u8, out JsonElement getOwningTypeProperty))
            {
                if (getOwningTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the ResultExpressionMembership.OwningType property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the owningType Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the ResultExpressionMembership.Source property is Redefined property which should not be present in the JSON. It was found in ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the ResultExpressionMembership.Target property is Redefined property which should not be present in the JSON. It was found in ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("type"u8, out _))
            {
                logger.LogDebug($"the ResultExpressionMembership.Type property is Redefined property which should not be present in the JSON. It was found in ResultExpressionMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the ResultExpressionMembership: {dtoInstance.ElementId}");
            }
