...
namespace KerML.NET.Serializer.Json
{
    ...
    public static class PackageDeSerializer
    {
        ...
        /// </returns>
        public static IPackage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Kernel.Packages.Package();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the filterCondition Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the importedMembership Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the member Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the membership Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedImport Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMember Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMembership Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Package: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the Package: {dtoInstance.ElementId}");
            }
