...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class FeatureInvertingDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IFeatureInverting DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Core.Features.FeatureInverting();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("featureInverted"u8, out JsonElement featureInvertedProperty))
            {
                ...
                {
                    dtoInstance.FeatureInverted = "-";
                    logger.LogDebug("the FeatureInverting.FeatureInverted property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (featureInvertedProperty.TryGetProperty("@id"u8, out JsonElement featureInvertedAtIdProperty))
                    {
                        var propertyValue = featureInvertedAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.FeatureInverted = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the featureInverted Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("invertingFeature"u8, out JsonElement invertingFeatureProperty))
            {
                ...
                {
                    dtoInstance.InvertingFeature = "-";
                    logger.LogDebug("the FeatureInverting.InvertingFeature property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (invertingFeatureProperty.TryGetProperty("@id"u8, out JsonElement invertingFeatureAtIdProperty))
                    {
                        var propertyValue = invertingFeatureAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.InvertingFeature = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the invertingFeature Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningFeature Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the FeatureInverting.Source property is Redefined property which should not be present in the JSON. It was found in FeatureInverting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the FeatureInverting.Target property is Redefined property which should not be present in the JSON. It was found in FeatureInverting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the FeatureInverting: {dtoInstance.ElementId}");
            }
