...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class SubclassificationDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static ISubclassification DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Core.Classifiers.Subclassification();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("general"u8, out _))
            {
                logger.LogDebug($"the Subclassification.General property is Redefined property which should not be present in the JSON. It was found in Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("owningClassifier"u8, out JsonElement getOwningClassifierProperty))
            {
                if (getOwningClassifierProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetOwningClassifier = null;
                }
                else
                {
                    if (getOwningClassifierProperty.TryGetProperty("@id"u8, out JsonElement getOwningClassifierAtIdProperty))
                    {
                        var propertyValue = getOwningClassifierAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetOwningClassifier = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the owningClassifier Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("owningType"u8, out _))
            {
                logger.LogDebug($"the Subclassification.OwningType property is Redefined property which should not be present in the JSON. It was found in Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the Subclassification.Source property is Redefined property which should not be present in the JSON. It was found in Subclassification: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("specific"u8, out _))
            {
                logger.LogDebug($"the Subclassification.Specific property is Redefined property which should not be present in the JSON. It was found in Subclassification: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("subclassifier"u8, out JsonElement subclassifierProperty))
            {
                ...
                {
                    dtoInstance.Subclassifier = "-";
                    logger.LogDebug("the Subclassification.Subclassifier property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (subclassifierProperty.TryGetProperty("@id"u8, out JsonElement subclassifierAtIdProperty))
                    {
                        var propertyValue = subclassifierAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.Subclassifier = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the subclassifier Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("superclassifier"u8, out JsonElement superclassifierProperty))
            {
                ...
                {
                    dtoInstance.Superclassifier = "-";
                    logger.LogDebug("the Subclassification.Superclassifier property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (superclassifierProperty.TryGetProperty("@id"u8, out JsonElement superclassifierAtIdProperty))
                    {
                        var propertyValue = superclassifierAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.Superclassifier = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the superclassifier Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the Subclassification.Target property is Redefined property which should not be present in the JSON. It was found in Subclassification: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the Subclassification: {dtoInstance.ElementId}");
            }
