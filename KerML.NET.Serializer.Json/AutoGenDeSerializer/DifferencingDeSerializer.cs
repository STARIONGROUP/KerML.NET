// -------------------------------------------------------------------------------------------------
// <copyright file="DifferencingDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class DifferencingDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IDifferencing DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Core.Types.Differencing();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("differencingType"u8, out JsonElement differencingTypeProperty))
            {
                ...
                {
                    dtoInstance.DifferencingType = "-";
                    logger.LogDebug("the Differencing.DifferencingType property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (differencingTypeProperty.TryGetProperty("@id"u8, out JsonElement differencingTypeAtIdProperty))
                    {
                        var propertyValue = differencingTypeAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.DifferencingType = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the differencingType Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the Differencing.Source property is Redefined property which should not be present in the JSON. It was found in Differencing: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the Differencing.Target property is Redefined property which should not be present in the JSON. It was found in Differencing: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("typeDifferenced"u8, out JsonElement getTypeDifferencedProperty))
            {
                if (getTypeDifferencedProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetTypeDifferenced = "-";
                    logger.LogDebug("the Differencing.TypeDifferenced property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getTypeDifferencedProperty.TryGetProperty("@id"u8, out JsonElement getTypeDifferencedAtIdProperty))
                    {
                        var propertyValue = getTypeDifferencedAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetTypeDifferenced = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the typeDifferenced Json property was not found in the Differencing: {dtoInstance.ElementId}");
            }
