// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureChainingDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class FeatureChainingDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IFeatureChaining DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            if (type.GetString() != "FeatureChaining")
            {
                throw new InvalidOperationException($"The FeatureChainingDeSerializer can only be used to deserialize objects of type IFeatureChaining, a {type.GetString()} was provided");
            }

            var dtoInstance = new KerML.NET.DTO.Core.Features.FeatureChaining();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("chainingFeature"u8, out JsonElement chainingFeatureProperty))
            {
                ...
                {
                    dtoInstance.ChainingFeature = "-";
                    logger.LogDebug("the FeatureChaining.ChainingFeature property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (chainingFeatureProperty.TryGetProperty("@id"u8, out JsonElement chainingFeatureAtIdProperty))
                    {
                        var propertyValue = chainingFeatureAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.ChainingFeature = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the chainingFeature Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("featureChained"u8, out JsonElement getFeatureChainedProperty))
            {
                if (getFeatureChainedProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetFeatureChained = "-";
                    logger.LogDebug("the FeatureChaining.FeatureChained property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getFeatureChainedProperty.TryGetProperty("@id"u8, out JsonElement getFeatureChainedAtIdProperty))
                    {
                        var propertyValue = getFeatureChainedAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetFeatureChained = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the featureChained Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the FeatureChaining.Source property is Redefined property which should not be present in the JSON. It was found in FeatureChaining: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the FeatureChaining.Target property is Redefined property which should not be present in the JSON. It was found in FeatureChaining: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the FeatureChaining: {dtoInstance.ElementId}");
            }
