// -------------------------------------------------------------------------------------------------
// <copyright file="NamespaceImportDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class NamespaceImportDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static INamespaceImport DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Root.Namespaces.NamespaceImport();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("importedElement"u8, out JsonElement getImportedElementProperty))
            {
                if (getImportedElementProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetImportedElement = "-";
                    logger.LogDebug("the NamespaceImport.ImportedElement property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getImportedElementProperty.TryGetProperty("@id"u8, out JsonElement getImportedElementAtIdProperty))
                    {
                        var propertyValue = getImportedElementAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetImportedElement = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the importedElement Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("importedNamespace"u8, out JsonElement importedNamespaceProperty))
            {
                if (importedNamespaceProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.ImportedNamespace = "-";
                    logger.LogDebug("the NamespaceImport.ImportedNamespace property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (importedNamespaceProperty.TryGetProperty("@id"u8, out JsonElement importedNamespaceAtIdProperty))
                    {
                        var propertyValue = importedNamespaceAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.ImportedNamespace = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the importedNamespace Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("importOwningNamespace"u8, out JsonElement getImportOwningNamespaceProperty))
            {
                if (getImportOwningNamespaceProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetImportOwningNamespace = "-";
                    logger.LogDebug("the NamespaceImport.ImportOwningNamespace property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getImportOwningNamespaceProperty.TryGetProperty("@id"u8, out JsonElement getImportOwningNamespaceAtIdProperty))
                    {
                        var propertyValue = getImportOwningNamespaceAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetImportOwningNamespace = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the importOwningNamespace Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImportAll Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isRecursive Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the NamespaceImport.Source property is Redefined property which should not be present in the JSON. It was found in NamespaceImport: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the NamespaceImport.Target property is Redefined property which should not be present in the JSON. It was found in NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the NamespaceImport: {dtoInstance.ElementId}");
            }
