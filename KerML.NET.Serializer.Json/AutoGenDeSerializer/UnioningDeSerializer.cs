// -------------------------------------------------------------------------------------------------
// <copyright file="UnioningDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// <summary>
    /// The purpose of the <see cref="UnioningDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IUnioning"/> interface
    /// </summary>
    public static class UnioningDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IUnioning"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        /// </returns>
        public static IUnioning DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the UnioningDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (type.GetString() != "Unioning")
            {
                throw new InvalidOperationException($"The UnioningDeSerializer can only be used to deserialize objects of type IUnioning, a {type.GetString()} was provided");
            }

            var dtoInstance = new KerML.NET.DTO.Core.Types.Unioning();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the Unioning cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the Unioning.Source property is Redefined property which should not be present in the JSON. It was found in Unioning: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the Unioning.Target property is Redefined property which should not be present in the JSON. It was found in Unioning: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("typeUnioned"u8, out JsonElement getTypeUnionedProperty))
            {
                if (getTypeUnionedProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetTypeUnioned = "-";
                    logger.LogDebug("the Unioning.TypeUnioned property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getTypeUnionedProperty.TryGetProperty("@id"u8, out JsonElement getTypeUnionedAtIdProperty))
                    {
                        var propertyValue = getTypeUnionedAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetTypeUnioned = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the typeUnioned Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("unioningType"u8, out JsonElement unioningTypeProperty))
            {
                ...
                {
                    dtoInstance.UnioningType = "-";
                    logger.LogDebug("the Unioning.UnioningType property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (unioningTypeProperty.TryGetProperty("@id"u8, out JsonElement unioningTypeAtIdProperty))
                    {
                        var propertyValue = unioningTypeAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.UnioningType = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the unioningType Json property was not found in the Unioning: {dtoInstance.ElementId}");
            }
