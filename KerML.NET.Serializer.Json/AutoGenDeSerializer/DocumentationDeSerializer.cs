// -------------------------------------------------------------------------------------------------
// <copyright file="DocumentationDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// <summary>
    /// The purpose of the <see cref="DocumentationDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IDocumentation"/> interface
    /// </summary>
    public static class DocumentationDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IDocumentation"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        /// </returns>
        public static IDocumentation DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the DocumentationDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (type.GetString() != "Documentation")
            {
            ...
            var dtoInstance = new KerML.NET.DTO.Root.Annotations.Documentation();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the Documentation cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("annotatedElement"u8, out _))
            {
                logger.LogDebug($"the Documentation.AnnotatedElement property is Redefined property which should not be present in the JSON. It was found in Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the annotation Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the body Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("documentedElement"u8, out JsonElement getDocumentedElementProperty))
            {
                if (getDocumentedElementProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetDocumentedElement = "-";
                    logger.LogDebug("the Documentation.DocumentedElement property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getDocumentedElementProperty.TryGetProperty("@id"u8, out JsonElement getDocumentedElementAtIdProperty))
                    {
                        var propertyValue = getDocumentedElementAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetDocumentedElement = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the documentedElement Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the locale Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotatingRelationship Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningAnnotatingRelationship Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the Documentation: {dtoInstance.ElementId}");
            }
