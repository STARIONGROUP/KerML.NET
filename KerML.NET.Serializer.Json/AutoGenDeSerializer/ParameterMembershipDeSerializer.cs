// -------------------------------------------------------------------------------------------------
// <copyright file="ParameterMembershipDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ParameterMembershipDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IParameterMembership"/> interface
    /// </summary>
    public static class ParameterMembershipDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IParameterMembership"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        /// </returns>
        public static IParameterMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ParameterMembershipDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (type.GetString() != "ParameterMembership")
            {
                throw new InvalidOperationException($"The ParameterMembershipDeSerializer can only be used to deserialize objects of type IParameterMembership, a {type.GetString()} was provided");
            }

            var dtoInstance = new KerML.NET.DTO.Kernel.Behaviors.ParameterMembership();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the ParameterMembership cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("feature"u8, out _))
            {
                logger.LogDebug($"the ParameterMembership.Feature property is Redefined property which should not be present in the JSON. It was found in ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberElement"u8, out _))
            {
                logger.LogDebug($"the ParameterMembership.MemberElement property is Redefined property which should not be present in the JSON. It was found in ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberElementId"u8, out _))
            {
                logger.LogDebug($"the ParameterMembership.MemberElementId property is Redefined property which should not be present in the JSON. It was found in ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberName"u8, out _))
            {
                logger.LogDebug($"the ParameterMembership.MemberName property is Redefined property which should not be present in the JSON. It was found in ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("membershipOwningNamespace"u8, out _))
            {
                logger.LogDebug($"the ParameterMembership.MembershipOwningNamespace property is Redefined property which should not be present in the JSON. It was found in ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberShortName"u8, out _))
            {
                logger.LogDebug($"the ParameterMembership.MemberShortName property is Redefined property which should not be present in the JSON. It was found in ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out _))
            {
                logger.LogDebug($"the ParameterMembership.OwnedMemberElement property is Redefined property which should not be present in the JSON. It was found in ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberElementId Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("ownedMemberFeature"u8, out _))
            {
                logger.LogDebug($"the ParameterMembership.OwnedMemberFeature property is Redefined property which should not be present in the JSON. It was found in ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberName Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("ownedMemberParameter"u8, out JsonElement getOwnedMemberParameterProperty))
            {
                if (getOwnedMemberParameterProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetOwnedMemberParameter = "-";
                    logger.LogDebug("the ParameterMembership.OwnedMemberParameter property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getOwnedMemberParameterProperty.TryGetProperty("@id"u8, out JsonElement getOwnedMemberParameterAtIdProperty))
                    {
                        var propertyValue = getOwnedMemberParameterAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetOwnedMemberParameter = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the ownedMemberParameter Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberShortName Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("owningType"u8, out JsonElement getOwningTypeProperty))
            {
                if (getOwningTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the ParameterMembership.OwningType property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the owningType Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the ParameterMembership.Source property is Redefined property which should not be present in the JSON. It was found in ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the ParameterMembership.Target property is Redefined property which should not be present in the JSON. It was found in ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("type"u8, out _))
            {
                logger.LogDebug($"the ParameterMembership.Type property is Redefined property which should not be present in the JSON. It was found in ParameterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the ParameterMembership: {dtoInstance.ElementId}");
            }
