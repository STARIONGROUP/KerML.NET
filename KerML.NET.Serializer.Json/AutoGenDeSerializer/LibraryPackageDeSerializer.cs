...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class LibraryPackageDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static ILibraryPackage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Kernel.Packages.LibraryPackage();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("filterCondition"u8, out JsonElement getFilterConditionProperty))
            {
                foreach (var arrayItem in getFilterConditionProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out JsonElement getFilterConditionAtIdProperty))
                    {
                        var propertyValue = getFilterConditionAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetFilterCondition.Add(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the filterCondition Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the importedMembership Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isStandard Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the member Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the membership Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedImport Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMember Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMembership Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the LibraryPackage: {dtoInstance.ElementId}");
            }
