// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureValueDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class FeatureValueDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IFeatureValue DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            if (type.GetString() != "FeatureValue")
            {
                throw new InvalidOperationException($"The FeatureValueDeSerializer can only be used to deserialize objects of type IFeatureValue, a {type.GetString()} was provided");
            }

            var dtoInstance = new KerML.NET.DTO.Kernel.FeatureValues.FeatureValue();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("featureWithValue"u8, out JsonElement getFeatureWithValueProperty))
            {
                if (getFeatureWithValueProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetFeatureWithValue = "-";
                    logger.LogDebug("the FeatureValue.FeatureWithValue property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getFeatureWithValueProperty.TryGetProperty("@id"u8, out JsonElement getFeatureWithValueAtIdProperty))
                    {
                        var propertyValue = getFeatureWithValueAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetFeatureWithValue = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the featureWithValue Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("isDefault"u8, out JsonElement isDefaultProperty))
            {
            ...
            {
                logger.LogDebug($"the isDefault Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("isInitial"u8, out JsonElement isInitialProperty))
            {
            ...
            {
                logger.LogDebug($"the isInitial Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberElement"u8, out _))
            {
                logger.LogDebug($"the FeatureValue.MemberElement property is Redefined property which should not be present in the JSON. It was found in FeatureValue: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberElementId"u8, out _))
            {
                logger.LogDebug($"the FeatureValue.MemberElementId property is Redefined property which should not be present in the JSON. It was found in FeatureValue: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberName"u8, out _))
            {
                logger.LogDebug($"the FeatureValue.MemberName property is Redefined property which should not be present in the JSON. It was found in FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("membershipOwningNamespace"u8, out JsonElement getMembershipOwningNamespaceProperty))
            {
                if (getMembershipOwningNamespaceProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the FeatureValue.MembershipOwningNamespace property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the membershipOwningNamespace Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberShortName"u8, out _))
            {
                logger.LogDebug($"the FeatureValue.MemberShortName property is Redefined property which should not be present in the JSON. It was found in FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out _))
            {
                logger.LogDebug($"the FeatureValue.OwnedMemberElement property is Redefined property which should not be present in the JSON. It was found in FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberElementId Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberName Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberShortName Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the FeatureValue.Source property is Redefined property which should not be present in the JSON. It was found in FeatureValue: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the FeatureValue.Target property is Redefined property which should not be present in the JSON. It was found in FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("value"u8, out JsonElement getValueProperty))
            {
                if (getValueProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetValue = "-";
                    logger.LogDebug("the FeatureValue.Value property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getValueProperty.TryGetProperty("@id"u8, out JsonElement getValueAtIdProperty))
                    {
                        var propertyValue = getValueAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetValue = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the value Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the FeatureValue: {dtoInstance.ElementId}");
            }
