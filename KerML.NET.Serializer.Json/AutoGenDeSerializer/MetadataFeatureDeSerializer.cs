...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class MetadataFeatureDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IMetadataFeature DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Kernel.Metadata.MetadataFeature();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the annotatedElement Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the annotation Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the chainingFeature Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the crossFeature Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the differencingType Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the directedFeature Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the direction Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the endFeature Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the endOwningType Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the feature Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the featureMembership Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("featureTarget"u8, out JsonElement getFeatureTargetProperty))
            {
                if (getFeatureTargetProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the MetadataFeature.FeatureTarget property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the featureTarget Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the featuringType Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the importedMembership Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the inheritedFeature Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the inheritedMembership Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the input Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the intersectingType Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isComposite Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isConjugated Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isDerived Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isEnd Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isOrdered Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isPortion Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isUnique Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the member Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the membership Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("metaclass"u8, out JsonElement getMetaclassProperty))
            {
                if (getMetaclassProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetMetaclass = null;
                }
                else
                {
                    if (getMetaclassProperty.TryGetProperty("@id"u8, out JsonElement getMetaclassAtIdProperty))
                    {
                        var propertyValue = getMetaclassAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetMetaclass = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the metaclass Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the multiplicity Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the output Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotatingRelationship Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedConjugator Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedCrossSubsetting Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedDifferencing Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedDisjoining Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedEndFeature Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeature Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeatureChaining Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeatureInverting Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeatureMembership Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedImport Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedIntersecting Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMember Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMembership Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRedefinition Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedReferenceSubsetting Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedSpecialization Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedSubsetting Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedTypeFeaturing Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedTyping Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedUnioning Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningAnnotatingRelationship Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningFeatureMembership Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningType Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the type Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the unioningType Json property was not found in the MetadataFeature: {dtoInstance.ElementId}");
            }
