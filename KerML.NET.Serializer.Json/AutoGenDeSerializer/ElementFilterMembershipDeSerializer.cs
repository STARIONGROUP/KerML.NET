// -------------------------------------------------------------------------------------------------
// <copyright file="ElementFilterMembershipDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ElementFilterMembershipDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IElementFilterMembership"/> interface
    /// </summary>
    public static class ElementFilterMembershipDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IElementFilterMembership"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        /// </returns>
        public static IElementFilterMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ElementFilterMembershipDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (type.GetString() != "ElementFilterMembership")
            {
                throw new InvalidOperationException($"The ElementFilterMembershipDeSerializer can only be used to deserialize objects of type IElementFilterMembership, a {type.GetString()} was provided");
            }

            var dtoInstance = new KerML.NET.DTO.Kernel.Packages.ElementFilterMembership();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the ElementFilterMembership cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("condition"u8, out JsonElement getConditionProperty))
            {
                if (getConditionProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.GetCondition = "-";
                    logger.LogDebug("the ElementFilterMembership.Condition property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (getConditionProperty.TryGetProperty("@id"u8, out JsonElement getConditionAtIdProperty))
                    {
                        var propertyValue = getConditionAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.GetCondition = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the condition Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberElement"u8, out _))
            {
                logger.LogDebug($"the ElementFilterMembership.MemberElement property is Redefined property which should not be present in the JSON. It was found in ElementFilterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberElementId"u8, out _))
            {
                logger.LogDebug($"the ElementFilterMembership.MemberElementId property is Redefined property which should not be present in the JSON. It was found in ElementFilterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberName"u8, out _))
            {
                logger.LogDebug($"the ElementFilterMembership.MemberName property is Redefined property which should not be present in the JSON. It was found in ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("membershipOwningNamespace"u8, out JsonElement getMembershipOwningNamespaceProperty))
            {
                if (getMembershipOwningNamespaceProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the ElementFilterMembership.MembershipOwningNamespace property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the membershipOwningNamespace Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberShortName"u8, out _))
            {
                logger.LogDebug($"the ElementFilterMembership.MemberShortName property is Redefined property which should not be present in the JSON. It was found in ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out _))
            {
                logger.LogDebug($"the ElementFilterMembership.OwnedMemberElement property is Redefined property which should not be present in the JSON. It was found in ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberElementId Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberName Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberShortName Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the ElementFilterMembership.Source property is Redefined property which should not be present in the JSON. It was found in ElementFilterMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the ElementFilterMembership.Target property is Redefined property which should not be present in the JSON. It was found in ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the ElementFilterMembership: {dtoInstance.ElementId}");
            }
