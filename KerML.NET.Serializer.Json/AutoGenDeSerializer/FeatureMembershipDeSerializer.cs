// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureMembershipDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class FeatureMembershipDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IFeatureMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Core.Types.FeatureMembership();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("feature"u8, out _))
            {
                logger.LogDebug($"the FeatureMembership.Feature property is Redefined property which should not be present in the JSON. It was found in FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberElement"u8, out _))
            {
                logger.LogDebug($"the FeatureMembership.MemberElement property is Redefined property which should not be present in the JSON. It was found in FeatureMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberElementId"u8, out _))
            {
                logger.LogDebug($"the FeatureMembership.MemberElementId property is Redefined property which should not be present in the JSON. It was found in FeatureMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberName"u8, out _))
            {
                logger.LogDebug($"the FeatureMembership.MemberName property is Redefined property which should not be present in the JSON. It was found in FeatureMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("membershipOwningNamespace"u8, out _))
            {
                logger.LogDebug($"the FeatureMembership.MembershipOwningNamespace property is Redefined property which should not be present in the JSON. It was found in FeatureMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("memberShortName"u8, out _))
            {
                logger.LogDebug($"the FeatureMembership.MemberShortName property is Redefined property which should not be present in the JSON. It was found in FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out _))
            {
                logger.LogDebug($"the FeatureMembership.OwnedMemberElement property is Redefined property which should not be present in the JSON. It was found in FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberElementId Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberFeature"u8, out JsonElement getOwnedMemberFeatureProperty))
            {
                if (getOwnedMemberFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the FeatureMembership.OwnedMemberFeature property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the ownedMemberFeature Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberName Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMemberShortName Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("owningType"u8, out JsonElement getOwningTypeProperty))
            {
                if (getOwningTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the FeatureMembership.OwningType property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the owningType Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the FeatureMembership.Source property is Redefined property which should not be present in the JSON. It was found in FeatureMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the FeatureMembership.Target property is Redefined property which should not be present in the JSON. It was found in FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("type"u8, out _))
            {
                logger.LogDebug($"the FeatureMembership.Type property is Redefined property which should not be present in the JSON. It was found in FeatureMembership: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the FeatureMembership: {dtoInstance.ElementId}");
            }
