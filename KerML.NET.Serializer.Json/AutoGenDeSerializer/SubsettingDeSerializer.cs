// -------------------------------------------------------------------------------------------------
// <copyright file="SubsettingDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class SubsettingDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static ISubsetting DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Core.Features.Subsetting();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("general"u8, out _))
            {
                logger.LogDebug($"the Subsetting.General property is Redefined property which should not be present in the JSON. It was found in Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningFeature Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("owningType"u8, out _))
            {
                logger.LogDebug($"the Subsetting.OwningType property is Redefined property which should not be present in the JSON. It was found in Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the Subsetting.Source property is Redefined property which should not be present in the JSON. It was found in Subsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("specific"u8, out _))
            {
                logger.LogDebug($"the Subsetting.Specific property is Redefined property which should not be present in the JSON. It was found in Subsetting: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("subsettedFeature"u8, out JsonElement subsettedFeatureProperty))
            {
                ...
                {
                    dtoInstance.SubsettedFeature = "-";
                    logger.LogDebug("the Subsetting.SubsettedFeature property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (subsettedFeatureProperty.TryGetProperty("@id"u8, out JsonElement subsettedFeatureAtIdProperty))
                    {
                        var propertyValue = subsettedFeatureAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.SubsettedFeature = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the subsettedFeature Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("subsettingFeature"u8, out JsonElement subsettingFeatureProperty))
            {
                ...
                {
                    dtoInstance.SubsettingFeature = "-";
                    logger.LogDebug("the Subsetting.SubsettingFeature property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (subsettingFeatureProperty.TryGetProperty("@id"u8, out JsonElement subsettingFeatureAtIdProperty))
                    {
                        var propertyValue = subsettingFeatureAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.SubsettingFeature = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the subsettingFeature Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the Subsetting.Target property is Redefined property which should not be present in the JSON. It was found in Subsetting: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the Subsetting: {dtoInstance.ElementId}");
            }
