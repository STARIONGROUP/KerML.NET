...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class MembershipImportDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IMembershipImport DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Root.Namespaces.MembershipImport();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("importedElement"u8, out JsonElement getImportedElementProperty))
            {
                if (getImportedElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the MembershipImport.ImportedElement property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the importedElement Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("importedMembership"u8, out JsonElement importedMembershipProperty))
            {
                ...
                {
                    dtoInstance.ImportedMembership = "-";
                    logger.LogDebug("the MembershipImport.ImportedMembership property was not found in the Json. The value is set to '-'");
                }
                else
                {
                    if (importedMembershipProperty.TryGetProperty("@id"u8, out JsonElement importedMembershipAtIdProperty))
                    {
                        var propertyValue = importedMembershipAtIdProperty.GetString();
                        if (propertyValue != null)
                        {
                            dtoInstance.ImportedMembership = propertyValue;
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug($"the importedMembership Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("importOwningNamespace"u8, out JsonElement getImportOwningNamespaceProperty))
            {
                if (getImportOwningNamespaceProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the MembershipImport.ImportOwningNamespace property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the importOwningNamespace Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImportAll Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isRecursive Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedElement Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the MembershipImport.Source property is Redefined property which should not be present in the JSON. It was found in MembershipImport: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the MembershipImport.Target property is Redefined property which should not be present in the JSON. It was found in MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the MembershipImport: {dtoInstance.ElementId}");
            }
