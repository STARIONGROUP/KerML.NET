// -------------------------------------------------------------------------------------------------
// <copyright file="ConnectorDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class ConnectorDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IConnector DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Kernel.Connectors.Connector();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the association Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the chainingFeature Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the connectorEnd Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the crossFeature Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the differencingType Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the directedFeature Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the direction Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Connector: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("endFeature"u8, out _))
            {
                logger.LogDebug($"the Connector.EndFeature property is Redefined property which should not be present in the JSON. It was found in Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the endOwningType Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the feature Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the featureMembership Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            if (jsonElement.TryGetProperty("featureTarget"u8, out JsonElement getFeatureTargetProperty))
            {
                if (getFeatureTargetProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug("the Connector.FeatureTarget property was not found in the Json. The value is set to '-'");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the featureTarget Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the featuringType Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the importedMembership Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the inheritedFeature Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the inheritedMembership Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the input Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the intersectingType Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isComposite Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isConjugated Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isDerived Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isEnd Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isOrdered Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isPortion Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isUnique Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the member Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the membership Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the multiplicity Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the output Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedConjugator Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedCrossSubsetting Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedDifferencing Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedDisjoining Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedEndFeature Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeature Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeatureChaining Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeatureInverting Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedFeatureMembership Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedImport Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedIntersecting Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMember Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedMembership Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRedefinition Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedReferenceSubsetting Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedSpecialization Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedSubsetting Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedTypeFeaturing Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedTyping Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedUnioning Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningFeatureMembership Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningType Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the Connector: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("relatedElement"u8, out _))
            {
                logger.LogDebug($"the Connector.RelatedElement property is Redefined property which should not be present in the JSON. It was found in Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the relatedFeature Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Connector: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("source"u8, out _))
            {
                logger.LogDebug($"the Connector.Source property is Redefined property which should not be present in the JSON. It was found in Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the sourceFeature Json property was not found in the Connector: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("target"u8, out _))
            {
                logger.LogDebug($"the Connector.Target property is Redefined property which should not be present in the JSON. It was found in Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the targetFeature Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the Connector: {dtoInstance.ElementId}");
            }

            if (jsonElement.TryGetProperty("type"u8, out _))
            {
                logger.LogDebug($"the Connector.Type property is Redefined property which should not be present in the JSON. It was found in Connector: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the unioningType Json property was not found in the Connector: {dtoInstance.ElementId}");
            }
