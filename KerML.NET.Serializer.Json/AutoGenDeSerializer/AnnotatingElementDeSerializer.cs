...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class AnnotatingElementDeSerializer
    {
        /// <summary>
        ...
        /// </returns>
        public static IAnnotatingElement DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory? loggerFactory = null)
        {
            ...
            var dtoInstance = new KerML.NET.DTO.Root.Annotations.AnnotatingElement();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the annotatedElement Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the annotation Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the documentation Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the isLibraryElement Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotatingRelationship Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedAnnotation Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedElement Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owner Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningAnnotatingRelationship Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningMembership Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningNamespace Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the qualifiedName Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
            ...
            {
                logger.LogDebug($"the textualRepresentation Json property was not found in the AnnotatingElement: {dtoInstance.ElementId}");
            }
