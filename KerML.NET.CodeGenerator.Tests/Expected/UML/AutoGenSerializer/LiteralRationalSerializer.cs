...
namespace KerML.NET.Serializer.Json
{
    ...
    /// </summary>
    public static class LiteralRationalSerializer
    {
        /// <summary>
        ...
        /// </param>
        /// <param name="inludeDerived">
        /// A value indicating whether derived properties shall be serialized or not
        /// </param>
        public static void Serialize(object obj, Utf8JsonWriter writer, SerializationModeKind serializationModeKind, bool inludeDerived)
        {
