...
namespace KerML.NET.DTO.Root.Dependencies
{
    ...
    public partial class Dependency : IDependency
    {
        ...
        {
            get => throw new NotSupportedException("IRelationship.Source has been redefined by IDependency.Client");
            set => throw new NotSupportedException("IRelationship.Source has been redefined by IDependency.Client");
        }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Target has been redefined by IDependency.Supplier");
            set => throw new NotSupportedException("IRelationship.Target has been redefined by IDependency.Supplier");
        }
