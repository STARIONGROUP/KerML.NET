...
namespace KerML.NET.DTO.Root.Annotations
{
    ...
    public partial class Documentation : IDocumentation
    {
        ...
        List<string> IAnnotatingElement.GetAnnotatedElement => throw new NotSupportedException("IAnnotatingElement.GetAnnotatedElement has been redefined by IDocumentation.DocumentedElement");
        ...
        public string GetDocumentedElement { get; internal set; }
