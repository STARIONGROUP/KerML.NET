...
namespace KerML.NET.DTO.Kernel.Expressions
{
    ...
    /// </summary>
    [Class(xmiId: "49166d3b-ea22-4546-b06a-13a88e2f8fa7", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    ...
    public partial class SelectExpression : ISelectExpression
    {
        ...
        {
            get => throw new NotSupportedException("IOperatorExpression.Operator has been redefined by ISelectExpression.Operator");
            set => throw new NotSupportedException("IOperatorExpression.Operator has been redefined by ISelectExpression.Operator");
        }
