...
namespace KerML.NET.DTO.Root.Namespaces
{
    ...
    public partial class NamespaceImport : INamespaceImport
    {
        ...
        public string ImportedNamespace { get; set; }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Target has been redefined by INamespaceImport.ImportedNamespace");
            set => throw new NotSupportedException("IRelationship.Target has been redefined by INamespaceImport.ImportedNamespace");
        }
