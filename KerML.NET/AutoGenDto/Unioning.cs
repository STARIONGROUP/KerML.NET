// -------------------------------------------------------------------------------------------------
// <copyright file="Unioning.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Core.Types
{
    ...
    public partial class Unioning : IUnioning
    {
        /// <summary>
        ...
        [SubsettedProperty(propertyName: "0d55f45c-0032-4618-9131-61ed58c3b8e2")]
        [RedefinedByProperty("IUnioning.TypeUnioned")]
        [Implements(implementation: "IRelationship.Source")]
        List<string> IRelationship.Source
        {
            get => throw new NotSupportedException("IRelationship.Source has been redefined by IUnioning.TypeUnioned");
            set => throw new NotSupportedException("IRelationship.Source has been redefined by IUnioning.TypeUnioned");
        }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Target has been redefined by IUnioning.UnioningType");
            set => throw new NotSupportedException("IRelationship.Target has been redefined by IUnioning.UnioningType");
        }
        ...
        public string GetTypeUnioned { get; internal set; }
        ...
        public string UnioningType { get; set; }
