// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureReferenceExpression.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Kernel.Expressions
{
    ...
    public partial class FeatureReferenceExpression : IFeatureReferenceExpression
    {
        /// <summary>
        ...
        [SubsettedProperty(propertyName: "9098f21e-06d6-46cd-b1c6-3ccde8f5d8bb")]
        [Implements(implementation: "IFeatureReferenceExpression.Referent")]
        public string GetReferent { get; internal set; }
