// -------------------------------------------------------------------------------------------------
// <copyright file="Conjugation.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Core.Types
{
    ...
    public partial class Conjugation : IConjugation
    {
        ...
        [Implements(implementation: "IConjugation.ConjugatedType")]
        public string ConjugatedType { get; set; }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Source has been redefined by IConjugation.ConjugatedType");
            set => throw new NotSupportedException("IRelationship.Source has been redefined by IConjugation.ConjugatedType");
        }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Target has been redefined by IConjugation.OriginalType");
            set => throw new NotSupportedException("IRelationship.Target has been redefined by IConjugation.OriginalType");
        }
