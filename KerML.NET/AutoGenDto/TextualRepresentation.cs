...
namespace KerML.NET.DTO.Root.Annotations
{
    ...
    public partial class TextualRepresentation : ITextualRepresentation
    {
        ...
        List<string> IAnnotatingElement.GetAnnotatedElement => throw new NotSupportedException("IAnnotatingElement.GetAnnotatedElement has been redefined by ITextualRepresentation.RepresentedElement");
        ...
        public string GetRepresentedElement { get; internal set; }
