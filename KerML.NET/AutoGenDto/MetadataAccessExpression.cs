// -------------------------------------------------------------------------------------------------
// <copyright file="MetadataAccessExpression.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Kernel.Expressions
{
    ...
    public partial class MetadataAccessExpression : IMetadataAccessExpression
    {
        ...
        [Implements(implementation: "IMetadataAccessExpression.ReferencedElement")]
        public string ReferencedElement { get; set; }
