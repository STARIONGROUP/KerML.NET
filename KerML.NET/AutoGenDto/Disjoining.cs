...
namespace KerML.NET.DTO.Core.Types
{
    ...
    public partial class Disjoining : IDisjoining
    {
        ...
        public string DisjoiningType { get; set; }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Source has been redefined by IDisjoining.TypeDisjoined");
            set => throw new NotSupportedException("IRelationship.Source has been redefined by IDisjoining.TypeDisjoined");
        }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Target has been redefined by IDisjoining.DisjoiningType");
            set => throw new NotSupportedException("IRelationship.Target has been redefined by IDisjoining.DisjoiningType");
        }
        ...
        public string TypeDisjoined { get; set; }
