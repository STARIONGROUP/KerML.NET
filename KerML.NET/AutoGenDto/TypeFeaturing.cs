...
namespace KerML.NET.DTO.Core.Features
{
    ...
    public partial class TypeFeaturing : ITypeFeaturing
    {
        ...
        {
            get => throw new NotSupportedException("IFeaturing.Feature has been redefined by ITypeFeaturing.FeatureOfType");
            set => throw new NotSupportedException("IFeaturing.Feature has been redefined by ITypeFeaturing.FeatureOfType");
        }
        ...
        public string FeatureOfType { get; set; }
        ...
        public string FeaturingType { get; set; }
        ...
        public string? GetOwningFeatureOfType { get; internal set; }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Source has been redefined by ITypeFeaturing.FeatureOfType");
            set => throw new NotSupportedException("IRelationship.Source has been redefined by ITypeFeaturing.FeatureOfType");
        }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Target has been redefined by ITypeFeaturing.FeaturingType");
            set => throw new NotSupportedException("IRelationship.Target has been redefined by ITypeFeaturing.FeaturingType");
        }
        ...
        {
            get => throw new NotSupportedException("IFeaturing.Type has been redefined by ITypeFeaturing.FeaturingType");
            set => throw new NotSupportedException("IFeaturing.Type has been redefined by ITypeFeaturing.FeaturingType");
        }
