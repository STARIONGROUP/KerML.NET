// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureInverting.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Core.Features
{
    ...
    public partial class FeatureInverting : IFeatureInverting
    {
        /// <summary>
        ...
        public string FeatureInverted { get; set; }
        ...
        public string InvertingFeature { get; set; }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Source has been redefined by IFeatureInverting.FeatureInverted");
            set => throw new NotSupportedException("IRelationship.Source has been redefined by IFeatureInverting.FeatureInverted");
        }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Target has been redefined by IFeatureInverting.InvertingFeature");
            set => throw new NotSupportedException("IRelationship.Target has been redefined by IFeatureInverting.InvertingFeature");
        }
