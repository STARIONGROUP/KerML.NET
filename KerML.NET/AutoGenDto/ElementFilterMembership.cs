// -------------------------------------------------------------------------------------------------
// <copyright file="ElementFilterMembership.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Kernel.Packages
{
    ...
    public partial class ElementFilterMembership : IElementFilterMembership
    {
        ...
        public string GetCondition { get; internal set; }
        ...
        string IOwningMembership.GetOwnedMemberElement => throw new NotSupportedException("IOwningMembership.GetOwnedMemberElement has been redefined by IElementFilterMembership.Condition");
