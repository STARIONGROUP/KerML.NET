...
namespace KerML.NET.DTO.Core.Features
{
    ...
    public partial class EndFeatureMembership : IEndFeatureMembership
    {
        ...
        public string GetOwnedMemberFeature { get; internal set; }
        ...
        string IFeatureMembership.GetOwnedMemberFeature => throw new NotSupportedException("IFeatureMembership.GetOwnedMemberFeature has been redefined by IEndFeatureMembership.OwnedMemberFeature");
