...
namespace KerML.NET.DTO.Core.Features
{
    ...
    public partial class ReferenceSubsetting : IReferenceSubsetting
    {
        ...
        string? ISubsetting.GetOwningFeature => throw new NotSupportedException("ISubsetting.GetOwningFeature has been redefined by IReferenceSubsetting.ReferencingFeature");
        ...
        public string ReferencedFeature { get; set; }
        ...
        public string GetReferencingFeature { get; internal set; }
        ...
        {
            get => throw new NotSupportedException("ISubsetting.SubsettedFeature has been redefined by IReferenceSubsetting.ReferencedFeature");
            set => throw new NotSupportedException("ISubsetting.SubsettedFeature has been redefined by IReferenceSubsetting.ReferencedFeature");
        }
        ...
        {
            get => throw new NotSupportedException("ISubsetting.SubsettingFeature has been redefined by IReferenceSubsetting.ReferencingFeature");
            set => throw new NotSupportedException("ISubsetting.SubsettingFeature has been redefined by IReferenceSubsetting.ReferencingFeature");
        }
