...
namespace KerML.NET.DTO.Core.Features
{
    ...
    public partial class CrossSubsetting : ICrossSubsetting
    {
        ...
        [Implements(implementation: "ICrossSubsetting.CrossedFeature")]
        public string CrossedFeature { get; set; }
        ...
        public string GetCrossingFeature { get; internal set; }
        ...
        string? ISubsetting.GetOwningFeature => throw new NotSupportedException("ISubsetting.GetOwningFeature has been redefined by ICrossSubsetting.CrossingFeature");
        ...
        {
            get => throw new NotSupportedException("ISubsetting.SubsettedFeature has been redefined by ICrossSubsetting.CrossedFeature");
            set => throw new NotSupportedException("ISubsetting.SubsettedFeature has been redefined by ICrossSubsetting.CrossedFeature");
        }
        ...
        {
            get => throw new NotSupportedException("ISubsetting.SubsettingFeature has been redefined by ICrossSubsetting.CrossingFeature");
            set => throw new NotSupportedException("ISubsetting.SubsettingFeature has been redefined by ICrossSubsetting.CrossingFeature");
        }
