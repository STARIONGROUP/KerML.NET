// -------------------------------------------------------------------------------------------------
// <copyright file="ResultExpressionMembership.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Kernel.Functions
{
    ...
    public partial class ResultExpressionMembership : IResultExpressionMembership
    {
        ...
        string IFeatureMembership.GetOwnedMemberFeature => throw new NotSupportedException("IFeatureMembership.GetOwnedMemberFeature has been redefined by IResultExpressionMembership.OwnedResultExpression");
        ...
        [Implements(implementation: "IResultExpressionMembership.OwnedResultExpression")]
        public string GetOwnedResultExpression { get; internal set; }
