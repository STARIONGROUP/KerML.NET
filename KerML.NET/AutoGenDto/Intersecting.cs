// -------------------------------------------------------------------------------------------------
// <copyright file="Intersecting.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Core.Types
{
    ...
    public partial class Intersecting : IIntersecting
    {
        /// <summary>
        ...
        [Implements(implementation: "IIntersecting.IntersectingType")]
        public string IntersectingType { get; set; }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Source has been redefined by IIntersecting.TypeIntersected");
            set => throw new NotSupportedException("IRelationship.Source has been redefined by IIntersecting.TypeIntersected");
        }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Target has been redefined by IIntersecting.IntersectingType");
            set => throw new NotSupportedException("IRelationship.Target has been redefined by IIntersecting.IntersectingType");
        }
        ...
        public string GetTypeIntersected { get; internal set; }
