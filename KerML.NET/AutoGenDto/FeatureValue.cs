...
namespace KerML.NET.DTO.Kernel.FeatureValues
{
    ...
    public partial class FeatureValue : IFeatureValue
    {
        ...
        public string GetFeatureWithValue { get; internal set; }
        ...
        string IOwningMembership.GetOwnedMemberElement => throw new NotSupportedException("IOwningMembership.GetOwnedMemberElement has been redefined by IFeatureValue.Value");
        ...
        public string GetValue { get; internal set; }
