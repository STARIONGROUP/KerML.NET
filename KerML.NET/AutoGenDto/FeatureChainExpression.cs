// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureChainExpression.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Kernel.Expressions
{
    ...
    public partial class FeatureChainExpression : IFeatureChainExpression
    {
        ...
        [Implements(implementation: "IInvocationExpression.Argument")]
        public List<string> GetArgument { get; internal set; }
        ...
        List<string> IStep.GetBehavior => throw new NotSupportedException("IStep.GetBehavior has been redefined by IExpression.Function");
        ...
        public string? GetFunction { get; internal set; }
        ...
        [Implements(implementation: "IFeatureChainExpression.Operator")]
        ...
        [RedefinedByProperty("IFeatureChainExpression.Operator")]
        [Implements(implementation: "IOperatorExpression.Operator")]
        string IOperatorExpression.Operator
        {
            get => throw new NotSupportedException("IOperatorExpression.Operator has been redefined by IFeatureChainExpression.Operator");
            set => throw new NotSupportedException("IOperatorExpression.Operator has been redefined by IFeatureChainExpression.Operator");
        }
        ...
        [SubsettedProperty(propertyName: "9098f21e-06d6-46cd-b1c6-3ccde8f5d8bb")]
        [Implements(implementation: "IFeatureChainExpression.TargetFeature")]
        public string GetTargetFeature { get; internal set; }
        ...
        public List<string> GetType { get; internal set; }
