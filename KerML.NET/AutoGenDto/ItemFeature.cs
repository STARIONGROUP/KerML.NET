// -------------------------------------------------------------------------------------------------
// <copyright file="ItemFeature.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Kernel.Interactions
{
    ...
    /// transfers that are instances of the ItemFlow.
    /// </summary>
    [Class(xmiId: "97959ade-1b78-4d79-a2d8-00f6a04bc749", isAbstract: false, isFinalSpecialization: false, isActive: false)]
