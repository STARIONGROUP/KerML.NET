...
namespace KerML.NET.DTO.Core.Classifiers
{
    ...
    public partial class Subclassification : ISubclassification
    {
        ...
        [RedefinedByProperty("ISubclassification.Superclassifier")]
        [Implements(implementation: "ISpecialization.General")]
        string ISpecialization.General
        {
            get => throw new NotSupportedException("ISpecialization.General has been redefined by ISubclassification.Superclassifier");
            set => throw new NotSupportedException("ISpecialization.General has been redefined by ISubclassification.Superclassifier");
        }
        ...
        public string? GetOwningClassifier { get; internal set; }
        ...
        string? ISpecialization.GetOwningType => throw new NotSupportedException("ISpecialization.GetOwningType has been redefined by ISubclassification.OwningClassifier");
        ...
        [RedefinedByProperty("ISubclassification.Subclassifier")]
        [Implements(implementation: "ISpecialization.Specific")]
        string ISpecialization.Specific
        {
            get => throw new NotSupportedException("ISpecialization.Specific has been redefined by ISubclassification.Subclassifier");
            set => throw new NotSupportedException("ISpecialization.Specific has been redefined by ISubclassification.Subclassifier");
        }
        ...
        [Implements(implementation: "ISubclassification.Subclassifier")]
        public string Subclassifier { get; set; }
        ...
        [Implements(implementation: "ISubclassification.Superclassifier")]
        public string Superclassifier { get; set; }
