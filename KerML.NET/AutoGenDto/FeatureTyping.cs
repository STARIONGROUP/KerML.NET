...
namespace KerML.NET.DTO.Core.Features
{
    ...
    public partial class FeatureTyping : IFeatureTyping
    {
        ...
        {
            get => throw new NotSupportedException("ISpecialization.General has been redefined by IFeatureTyping.Type");
            set => throw new NotSupportedException("ISpecialization.General has been redefined by IFeatureTyping.Type");
        }
        ...
        string? ISpecialization.GetOwningType => throw new NotSupportedException("ISpecialization.GetOwningType has been redefined by IFeatureTyping.OwningFeature");
        ...
        {
            get => throw new NotSupportedException("ISpecialization.Specific has been redefined by IFeatureTyping.TypedFeature");
            set => throw new NotSupportedException("ISpecialization.Specific has been redefined by IFeatureTyping.TypedFeature");
        }
        ...
        public string TypedFeature { get; set; }
