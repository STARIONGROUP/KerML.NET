// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureChaining.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Core.Features
{
    ...
    public partial class FeatureChaining : IFeatureChaining
    {
        /// <summary>
        ...
        [Implements(implementation: "IFeatureChaining.ChainingFeature")]
        public string ChainingFeature { get; set; }
        ...
        [Implements(implementation: "IFeatureChaining.FeatureChained")]
        public string GetFeatureChained { get; internal set; }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Source has been redefined by IFeatureChaining.FeatureChained");
            set => throw new NotSupportedException("IRelationship.Source has been redefined by IFeatureChaining.FeatureChained");
        }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Target has been redefined by IFeatureChaining.ChainingFeature");
            set => throw new NotSupportedException("IRelationship.Target has been redefined by IFeatureChaining.ChainingFeature");
        }
