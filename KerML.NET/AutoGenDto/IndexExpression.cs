// -------------------------------------------------------------------------------------------------
// <copyright file="IndexExpression.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Kernel.Expressions
{
    ...
    public partial class IndexExpression : IIndexExpression
    {
        /// <summary>
        ...
        [Implements(implementation: "IIndexExpression.Operator")]
        ...
        {
            get => throw new NotSupportedException("IOperatorExpression.Operator has been redefined by IIndexExpression.Operator");
            set => throw new NotSupportedException("IOperatorExpression.Operator has been redefined by IIndexExpression.Operator");
        }
