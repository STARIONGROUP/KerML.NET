// -------------------------------------------------------------------------------------------------
// <copyright file="Invariant.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Kernel.Functions
{
    ...
    public partial class Invariant : IInvariant
    {
        ...
        string? IExpression.GetFunction => throw new NotSupportedException("IExpression.GetFunction has been redefined by IBooleanExpression.Predicate");
        ...
        [Implements(implementation: "IInvariant.IsNegated")]
        ...
        public string? GetPredicate { get; internal set; }
