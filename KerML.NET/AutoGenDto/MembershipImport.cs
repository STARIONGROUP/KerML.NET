...
namespace KerML.NET.DTO.Root.Namespaces
{
    ...
    public partial class MembershipImport : IMembershipImport
    {
        ...
        public string GetImportedElement { get; internal set; }
        ...
        public string ImportedMembership { get; set; }
        ...
        public string GetImportOwningNamespace { get; internal set; }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Source has been redefined by IImport.ImportOwningNamespace");
            set => throw new NotSupportedException("IRelationship.Source has been redefined by IImport.ImportOwningNamespace");
        }
        ...
        {
            get => throw new NotSupportedException("IRelationship.Target has been redefined by IMembershipImport.ImportedMembership");
            set => throw new NotSupportedException("IRelationship.Target has been redefined by IMembershipImport.ImportedMembership");
        }
