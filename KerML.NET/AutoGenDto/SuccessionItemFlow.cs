// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionItemFlow.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Kernel.Interactions
{
    ...
    public partial class SuccessionItemFlow : ISuccessionItemFlow
    {
        ...
        [RedefinedByProperty("IItemFlow.Interaction")]
        [Implements(implementation: "IConnector.Association")]
        List<string> IConnector.GetAssociation => throw new NotSupportedException("IConnector.GetAssociation has been redefined by IItemFlow.Interaction");
        ...
        List<string> IStep.GetBehavior => throw new NotSupportedException("IStep.GetBehavior has been redefined by IItemFlow.Interaction");
        ...
        List<string> IType.GetDirectedFeature => throw new NotSupportedException("IType.GetDirectedFeature has been redefined by IStep.Parameter");
        ...
        [Implements(implementation: "ISuccession.EffectStep")]
        public List<string> GetEffectStep { get; internal set; }
        ...
        [Implements(implementation: "ISuccession.GuardExpression")]
        public List<string> GetGuardExpression { get; internal set; }
        ...
        [Implements(implementation: "IItemFlow.Interaction")]
        public List<string> GetInteraction { get; internal set; }
        ...
        [Implements(implementation: "IItemFlow.ItemFeature")]
        public string? GetItemFeature { get; internal set; }
        ...
        [Implements(implementation: "IItemFlow.ItemFlowEnd")]
        public List<string> GetItemFlowEnd { get; internal set; }
        ...
        [Implements(implementation: "IItemFlow.ItemType")]
        public List<string> GetItemType { get; internal set; }
        ...
        [Implements(implementation: "IItemFlow.SourceOutputFeature")]
        public string? GetSourceOutputFeature { get; internal set; }
        ...
        [Implements(implementation: "IItemFlow.TargetInputFeature")]
        public string? GetTargetInputFeature { get; internal set; }
        ...
        [Implements(implementation: "ISuccession.TransitionStep")]
        public string? GetTransitionStep { get; internal set; }
        ...
        [Implements(implementation: "ISuccession.TriggerStep")]
        public List<string> GetTriggerStep { get; internal set; }
