// -------------------------------------------------------------------------------------------------
// <copyright file="CollectExpression.cs" company="Starion Group S.A.">
//
...
namespace KerML.NET.DTO.Kernel.Expressions
{
    ...
    public partial class CollectExpression : ICollectExpression
    {
        ...
        [Implements(implementation: "ICollectExpression.Operator")]
        ...
        {
            get => throw new NotSupportedException("IOperatorExpression.Operator has been redefined by ICollectExpression.Operator");
            set => throw new NotSupportedException("IOperatorExpression.Operator has been redefined by ICollectExpression.Operator");
        }
