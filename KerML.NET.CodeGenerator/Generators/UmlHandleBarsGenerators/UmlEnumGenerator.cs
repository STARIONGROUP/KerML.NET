...
namespace KerML.NET.CodeGenerator.Generators.UmlHandleBarsGenerators
{
    ...
    /// </summary>
    public class UmlEnumGenerator : UmlHandleBarsGenerator
    {
        /// <summary>
        /// Generates the KerML Enumerations
        /// </summary>
        ...
        {
            var template = this.Templates["enumeration-uml-template"];
        ...
        {
            this.RegisterTemplate("enumeration-uml-template");
        }
    }
}
