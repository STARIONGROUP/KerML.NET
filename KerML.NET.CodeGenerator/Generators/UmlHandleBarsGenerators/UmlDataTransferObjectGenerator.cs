// -------------------------------------------------------------------------------------------------
// <copyright file="UmlDataTransferObjectGenerator.cs" company="Starion Group S.A.">
// 
...
namespace KerML.NET.CodeGenerator.Generators.UmlHandleBarsGenerators
{
    ...
    /// </summary>
    public class UmlDataTransferObjectGenerator : UmlHandleBarsGenerator
    {
        /// <summary>
        /// Generates the KerML classes as DTO interfaces and classes
        /// </summary>
